...
class TestAnkiTodayService(TestCase):
    ...
    def test_get_cards_empty_decks(self):
        ...
        self.mock_repository.get_today_review.return_value = expected
        
        result = self.service.get_cards()
        
        self.assertEqual(result, expected)
        self.mock_repository.get_today_review.assert_called_once()
    ...
    def test_get_cards_deck_with_no_cards(self):
        ...
        self.mock_repository.get_today_review.return_value = TodayReview([])
    ...
    def test_get_cards_deck_with_all_card_types(self):
        ...
        self.mock_repository.get_today_review.return_value = TodayReview([deck])
